...
public class DeleteAccount {
    ...
    public void test1_Delete() {
        ...
        //personalInfo
        String personalInfoXpath="";
        ClientDriver.base.waitForElementToBeVisibleBy(By.xpath(personalInfoXpath));
        ClientDriver.base.getElementByXpath(personalInfoXpath).click();
        //Delete buttom
        String logOutXpath="";
        ClientDriver.base.getElementByXpath(logOutXpath).click();
